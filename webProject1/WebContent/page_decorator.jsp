...
<body>
	<div id="wrap">
		...
		<header>
			<!--로고 들어가는 곳 시작--->
			<div id="logo">
				<a href="index.do"> <img src="images/logo.gif" width="180"
				...
				<ul>
					<c:choose>
						<c:when test="${empty sessionScope.loginUser}">
							<li><a href="loginForm.do" style="width: 110px;">LOGIN&nbsp;(CUSTOMER</a>
								<a href="admin/adminLoginForm.do">| ADMIN)</a></li>
							<li>/</li>
			...
			<nav id="top_menu">
				<ul>
					...
					<li><a href="catagory.do?kind=5">On Sale</a></li>
				</ul>
			</nav>
			<div class="clear"></div>
			<hr>
